...
final class GlobalDefinitions {
    ...
    static let apiKey = "fy2wuEZSiOP6xeoZ"

    static let sdkDomainUrl = "https://analytics.korrekted.com"
    static let sdkApiKey = "pTD5SAPWu8y7C9z7"

    static let applicationTag = "EXAM_MCAT"

    static let amplitudeApiKey = "b503251969f4b1d7901d2f7d1388d476"
    static let appsFlyerApiKey = "DCciCfYXjMQ8QnkdCg8qzk"

    static let appStoreUrl = "https://apps.apple.com/app/mcat-prep/id1568228652"
    static let appleAppID = "1568228652"
